...
class DeepSet(nn.Module):
	...
	def __init__(
		...
		self.d_ij_transform = nn.Linear(132, 256, dtype=dtype) #Refine how interatomic distances contribute
	...
	def forward(self,
		...
		z = z.view(-1, 1)
		x = self.embedding(z.long()).squeeze(1) #Unsqueeze to become 1D to 2D
...
[
		...
		# ? Pairwise gnn output
		gnn_output = self.gat1(x, edge_index)
